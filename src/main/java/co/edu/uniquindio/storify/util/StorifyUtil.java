...
public class StorifyUtil {
    ...
    public static TiendaMusica inicializarDatosPrueba() {
        ...
        persona1.getCancionesFavoritas().add(new Cancion( "Thriller", "Thriller", "", 1982, 5.57, TipoGenero.POP,""));
        persona1.getCancionesFavoritas().add(new Cancion("Billie Jean", "Thriller", "", 1982, 4.54, TipoGenero.POP,""));
        ...
        artista1.getCanciones().add(new Cancion( "Thriller", "Thriller", "", 1982, 5.57, TipoGenero.POP,""));
        artista1.getCanciones().add(new Cancion( "Billie Jean", "Thriller", "", 1982, 4.54, TipoGenero.POP,""));
        ...
        artista2.getCanciones().add(new Cancion("Hey Jude", "The Beatles (The White Album)", "", 1968, 7.11, TipoGenero.ROCK,""));
        artista2.getCanciones().add(new Cancion( "Let It Be", "Let It Be", "", 1970, 3.50, TipoGenero.ROCK,""));
        ...
        artista3.getCanciones().add(new Cancion( "Single Ladies (Put a Ring on It)", "I Am... Sasha Fierce", "", 2008, 3.13, TipoGenero.POP,""));
        artista3.getCanciones().add(new Cancion("Halo", "I Am... Sasha Fierce", "", 2008, 4.22, TipoGenero.POP,""));
        //tiendaMusica.getArtistas().put("ART003", artista3);

        Artista artista4 = new Artista("ART004", "Queen", "Reino Unido", TipoArtista.BANDA);
        artista4.getCanciones().add(new Cancion( "Bohemian Rhapsody", "A Night at the Opera", "", 1975, 5.55, TipoGenero.ROCK,""));
        artista4.getCanciones().add(new Cancion( "We Will Rock You", "News of the World", "", 1977, 2.02, TipoGenero.ROCK,""));
